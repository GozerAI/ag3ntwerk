"""LicenseGate — feature entitlement checker for ag3ntwerk.
...
Usage:
    from ag3ntwerk.licensing import license_gate

    # Imperative check
    license_gate.gate("agw.learning.pipeline")

    # Decorator
    @license_gate.require_feature("agw.distributed.fleet")
    def orchestrate_fleet(self):
        ...
"""
...
_FEATURE_TIER_MAP = {
    # Pro (Tier 2)
    "agw.learning.pipeline": ("Learning Pipeline", "Pro"),
    "agw.learning.facades": ("Learning Facades", "Pro"),
    "agw.learning.self_architect": ("Self-Architect", "Pro"),
    "agw.learning.meta_learner": ("Meta-Learner", "Pro"),
    "agw.learning.cascade_predictor": ("Cascade Predictor", "Pro"),
    # Enterprise (Tier 1)
    "agw.vls.pipeline": ("VLS Pipeline", "Enterprise"),
    "agw.vls.evidence": ("Evidence Gates", "Enterprise"),
    "agw.vls.workflows": ("VLS Workflows", "Enterprise"),
    "agw.metacognition.advanced": ("Advanced Metacognition", "Enterprise"),
    "agw.distributed.fleet": ("Fleet Orchestration", "Enterprise"),
    "agw.swarm_bridge": ("Swarm Bridge", "Enterprise"),
}
