...
class Product:
    ...
    def inventory_value(self) -> float:
        ...
        return sum((v.cost or 0) * v.inventory_quantity for v in self.variants)
...
class StorefrontRegistry:
    ...
    def save_config(self) -> None:
        ...
        config = {"storefronts": {s.key: s.to_dict() for s in self._storefronts.values()}}
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "by_platform": {p.value: len(self.list_by_platform(p)) for p in StorefrontPlatform},
