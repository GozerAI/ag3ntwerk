...
class TestMCPHandlers:
    ...
    def test_get_handler_returns_correct_handler(self, mock_server):
        ...
        tool_handlers = {
            ...
            "csuite_find_executive_for_task": mock_server._handle_find_executive,
            "csuite_execute_task": mock_server._handle_execute_task,
            "csuite_route_task": mock_server._handle_route_task,
            "csuite_list_workflows": mock_server._handle_list_workflows,
            "csuite_run_workflow": mock_server._handle_run_workflow,
            "csuite_system_status": mock_server._handle_system_status,
            "csuite_agent_capabilities": mock_server._handle_capabilities,
        }
    ...
    def test_tools_constant(self, mock_server):
        ...
        expected_tools = [
            ...
            "ag3ntwerk_get_agent",
            "csuite_find_executive_for_task",
            "csuite_execute_task",
            "csuite_route_task",
            "csuite_list_workflows",
            "csuite_run_workflow",
            "csuite_system_status",
            "csuite_agent_capabilities",
        ]
